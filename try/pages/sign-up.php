...
<body class="">
  ...
  <main class="main-content  mt-0">
    <div class="page-header align-items-start min-vh-50 pt-5 pb-11 m-3 border-radius-lg" style="background-image: url('https://www.dpwh.gov.ph/DPWH/sites/default/files/cassanova_creek_fc_1.jpg'); background-position: top;">
          ...
          <div class="card z-index-0">
            ...
            <div class="card-body">
              <form role="form" method="POST" action="signup-process.php">
                ...
                <div class="mb-3">
                  <input type="text" class="form-control" name="contact" placeholder="Contact" aria-label="Contact" required>
                </div>
                <div class="mb-3">
